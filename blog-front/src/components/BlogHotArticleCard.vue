  ...
  <el-card>
    <template #header>
      <div class="flex items-center">
        <el-icon :size="25">
          <Icon icon="emojione-v1:fire" />
        </el-icon>
        <span class="ml-2 text-base font-bold">热门文章</span>
      </div>
    </template>
...
import { getHotArticleListApi } from "@/api/article";
import { onMounted } from "vue";

const hotArticles = reactive<IArticles[]>([]);

/**
 * 获取热门文章
 */
const getHuotArticles = async () => {
